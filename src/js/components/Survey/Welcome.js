                    ...
                    <div className="col-md-12"> 
                        <div className="Info" >
                            ...
                            <ol type="1">
                                ...
                                <li><b>Final test</b>. We will give you {NUM_EXERCISES} exercises to complete to see how much you have learned while watching the course video and searching; those exercises include questions about the given topic and the writing of an outline for your paper about this topic.
