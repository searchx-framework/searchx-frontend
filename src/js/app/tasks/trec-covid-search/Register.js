...
const formData = function() {
    ...
    elements.push({
        ...
        name: "start",
        html: `
        <h3>Help us learn more about the novel coronavirus!</h3>
        
        <hr/>
        <p> As researchers, clinicians, policy makers are involved with the response to COVID-19, the novel coronavirus, it is becoming 
        increasingly necessary for them and for the rest of us to find reliable information about the disease. In this study, we require you to help 
        us with a critical step of this information seeking process - the query formulation. We use the web on a regular basis to find various information
        we need. To do so, we often express our information need (e.g. 'comparing prices and buying running shoes for women')  by formulating a query 
        (e.g. 'price of women's running shoes' etc.) and provide it to a search engine. The search engine in turn provides us with a list of results. 
        If the query is not well formed or ambiguous we might not often what we are looking for. </p>

        <p> In this study we will provide you with 10 information need (e.g. 'Looking for information on all possible ways to contract COVID-19 from people, animals and objects') 
        relating to COVID-19, and you have to provide us with the best query that represents that particular information need. There is no right answer here. 
        Imagine that you are searching the web with that particular information need. Provide us with the query that you would issue in the web to get documents or 
        websites or links answering your information need. <p> 
        
        <p> In the next page we will ask you to fill some basic information regarding you. Following that, we will provide you with the list of ten
        information need related to COVID-19. For each of them, there will be space for you to provide the query that you would issue for that need.
        Please provide only <b>one</b> query per information need. Try to make sure there are no spelling mistakes while doing the same.</p>

        <p> We have a few important points: </p>
        <ol type="-">
            <li>
                <p>
                Only use the interface we provide. Do not use another web search interface to test your queries.
            ...
            <li> 
                ...
                For example, if your information need is  'Looking for information on all possible ways to contract COVID-19 from people, 
                animals and objects', we consider queries for tomorrow's weather, the latest news on Brexit, movie reviews of the Avenger movies, 
                as off-topic and will cancel your participation.
                </p>
            </li>
        </ol>
        <hr/>
