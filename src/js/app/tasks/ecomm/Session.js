...
class Session extends React.PureComponent {
    ...
    render() {
        ...
        const taskDescription = (
            ...
            {getTaskDescription(task.data.topics[t].taskType)}

            <br/>


            <p> SearchX is a specialized search engine for online products, use it to find relevant products for your shopping need. Do not use any other Web search engine. </p>
