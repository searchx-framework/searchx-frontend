...
const formData = function(topic) {
    ...
    Helpers.shuffle(Object.keys(topic)).forEach((term, idx) => {
    ...
    elements.push({
        ...
        html: "<b>We would also like you to describe your experience while taking part in our study. This information will help us in making the study better for future usage. It will also help us to analyze user experience during the study. </b>"
    });
    ...
    elements.push({
        title: "Do you have any additional comments regarding the task?",
